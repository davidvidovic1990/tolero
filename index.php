...
<body>
      ...
      <!-- Brand and toggle get grouped for better mobile display -->
        <div class="navbar-header">
          <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navigation-nav">
           ...
           <a class="navbar-brand" href="index.php"><img src="assets/images/logoMini.png" alt=""></a>
        </div>
  ...
  ================================================== -->
              ...
              <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="hero-text">
                  <div class="herolider">
                      ...
                      <li class="caption">
                        <h1>Knjigovodstveni servis TOLERO</h1>
                      </li>
                  </div> <!-- end herolider -->
                </div> <!-- end hero-text -->

                <div  class="hero-btn">
                  <a href="#o-nama" class="btn btn-clean">Više</a>
                </div> <!-- end hero-btn -->
              </div> <!-- end col-md-6 -->
            </div> <!-- end row -->
          </div> <!-- End container -->
    ...
    ================================================== -->
    <section>
      <div id="o-nama" class="pad-sec">
        <div class="container">

          <div class="title-section big-title-sec animated out" data-animation="fadeInUp" data-delay="0">
            <div class="row">
              <div class="col-sm-8 col-sm-offset-2">
              <h2 class="big-title">O Nama</h2>
                <h1 class="big-subtitle">Mi smo Tolero</h1>
                <hr>
                <p class="about-text">Tolero servis d.o.o. nudi potpunu uslugu računovodstva, na području grada Zagreba i Zagrebačke županije. Od 2011. godine pomažemo malim i srednjim poduzetnicima pri ostvarenju poslovnih ciljeva pružanjem usluga s područja računovodstva i financija. Točnost, uslužnost i stručnost su naše temeljne vrijednosti.</p>
              </div>
            </div> <!-- End row -->
          ...
          <div class="offer-boxes">
            ...
            <div class="col-sm-4">
              <div class="offer-post text-center animated out" data-animation="fadeInLeft" data-delay="0">
                ...
                <p>Pomoć pri otvaranju obrta ili firme</p>
              </div> <!-- End offer-post -->
            </div> <!-- End col-sm-4 -->
            ...
            <div class="col-sm-4">
              <div class="offer-post text-center animated out" data-animation="fadeInUp" data-delay="0">
                ...
                <h4>OBRTI</h4>
                <p>Knjigovodstvene usluge za obrtnike</p>
              </div> <!-- End offer-post -->
            </div> <!-- End col-sm-4 -->
            ...
            <div class="col-sm-4">
              <div class="offer-post text-center animated out" data-animation="fadeInRight" data-delay="0">
                ...
                <h4>TRGOVAČKA DRUŠTVA</h4>
                <p>Knjigovodstvene usluge za male i srednje poduzetnike</p>
              </div> <!-- End offer-post -->
            </div> <!-- End col-sm-4 -->
    ...
    ================================================== -->
    <section>
      <div id="nase-usluge" class="pad-sec">
        <div class="container">
...
7              </div> <!-- edn col-sm-8 -->
          ...
          <div class="row">
                ...
                <ul class="features-list">
                  ...
                  <li>
                    <div class="left-features-box animated out" data-animation="fadeInLeft" data-delay="0">
                      ...
                      <div class="features-box-content">
                        <h6>Komunikacija s poreznom upravom</h6>
                      </div> <!-- end features-box-content -->
                    </div> <!-- end left-features-box -->
                  </li>
                  <!-- feature -->
                  ...
                  <li>
                    <div class="left-features-box animated out" data-animation="fadeInLeft" data-delay="0">
                      ...
                      <div class="features-box-content">
                        <h6>Vođenje temeljnih i pomoćnih poslovnih knjiga</h6>
                      </div> <!-- end features-box-content -->
                    </div> <!-- end left-features-box -->
                  </li>
                  <!-- feature -->
            ...
            <div class="col-md-6">
              <div class="features-image animated out" data-animation="fadeInUp" data-delay="0">
                <img src="assets/images/temp/docCoff.jpg" alt="">
                ...
                <ul class="features-list">
                  ...
                  <li>
                    <div class="right-features-box animated out" data-animation="fadeInRight" data-delay="0">
                      ...
                      <div class="features-box-content">
                        <h6>Izrada završnih obračuna</h6>
                      </div>
                    </div>
                  </li>
                  <!-- feature -->
    ...
    <section>
      <div  id="novosti" class="pad-sec2" style="  margin: auto;      width: 60%;      padding: 10px;">
    <div class="container">
        <h2>Novosti</h2>
      ...
      $conn = OpenCon();
        ...
        while($row = mysqli_fetch_assoc($resultsd1)){   //Creates a loop to loop through results
          ...
          <a href="blog.php#<?php echo $row["ID"]?>" class="article_box_header_link"><span> <?php echo $row["naslov"]?></span></a>
    ...
    <h2><a href="blog.php" style="right: 150px; position: absolute">Sve novosti</a></h2>
          ...
          <div class="title-section text-center animated out" data-animation="fadeInUp" data-delay="0">
              <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                  ...
                  <hr>
                  <p>Nađite nas na lokaciji Trg žrtava fašizma 15, Zaprešić</p>
              </div>
            </div> <!-- End row -->
          </div> <!-- end title-section -->
          ...
          <div class="form-wrapper">
            <div class="row">
              ...
              <!-- Google map
                ================================================== -->
                  <div id="module-maps">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2778.4677274851065!2d15.788234215570862!3d45.861951079107705!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4765cf7314b2afc1%3A0xcd8c6caea6a7db54!2zT2JydWJpxIdpIHVsLiAyQSwgMTAyOTAsIFphcHJlxaFpxIc!5e0!3m2!1sen!2shr!4v1645292128616!5m2!1sen!2shr" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>                  </div>
                <br>
                <br>
                <br>
                <!-- End Google map -->
                ...
                <form action="assets/php/contact.php.htm" method="post" name="contactform" id="contactform" class="animated out" data-animation="fadeInUp" data-delay="0">
                  ...
                  <fieldset>
                    <div class="form-group">
                      <input class="form-control br-b" type="text" name="name" id="name" placeholder="Ime">
                    </div>
                    ...
                    <div class="form-group">
                      <textarea class="form-control br-b" name="message" id="message" placeholder="Poruka..."></textarea>
                    </div>
                  </fieldset>
                  
                  <!-- submit button -->
                  <div class="form-group">
                    <input type="submit" name="submit" value="Pošalji poruku" id="submit" class="btn btn-sm btn-dark">
                  </div>
    ...
    <section>
      <div class="contact-info">
        <div class="container">
          <div class="row">
            <div class="col-sm-4">
              <a href="#"><i class="pe-7s-map-marker"></i>Obrubići ul. 2A, 10290, Zaprešić</a>
            </div> <!-- End col-sm-4 -->
            <div class="col-sm-4">
            <a href="tel:+123000456"><i class="pe-7s-phone"></i>+385 1234 567</a>
            </div>
             <div class="col-sm-4">
              <a href="#"><i class="pe-7s-mail"></i>mail@mail.com</a>
             </div>
          </div> <!-- End row -->
        </div> <!-- End container -->
